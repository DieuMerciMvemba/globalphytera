...
export class RuleEngineService {
  ...
  async evaluate(data: EvaluateTelemetryInput) {
    ...
    if (humAir != null && tempAir != null && humAir >= 80 && tempAir >= 20 && tempAir <= 25) {
    ...
    if (humAir != null && tempAir != null && humAir >= 50 && humAir <= 70 && tempAir >= 20 && tempAir <= 30) {
      await this.triggerAlert({
        fieldId,
        deviceId,
        userId,
    ...
    if (phSol != null && (phSol < 5.5 || phSol > 7.5)) {
      await this.triggerAlert({
        fieldId,
        deviceId,
        userId,
    ...
    if (tempAir != null && (tempAir > 38 || tempAir < 5)) {
      await this.triggerAlert({
        fieldId,
        deviceId,
        userId,
